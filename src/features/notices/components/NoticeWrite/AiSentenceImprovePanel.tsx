         ...
         <div className="px-6 py-5">
            ...
            <div className="mt-2 flex flex-col gap-2">
               {suggestions.map((suggestion, index) => (
                  <div key={index} className="grid grid-cols-1 gap-2 sm:grid-cols-2 sm:gap-4">
                     <div>
                        <span className="mb-1 block text-xs font-semibold text-[#9CA3AF] sm:hidden">
                           원문
                        </span>
                     ...
                     <div>
                        <span className="mb-1 block text-xs font-semibold text-brand-green sm:hidden">
                           AI 제안
                        </span>
